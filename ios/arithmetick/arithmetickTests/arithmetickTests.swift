...
class arithmetickTests: XCTestCase {
    ...
    func testHelperMethods() {
        let testModel = ConversionViewModel.testModel()
        
        // empty value works like 0
        ...
        // not numerical values will get skip conversion
    ...
    func testLengthConversions() {
        ...
        XCTAssertEqual(viewModel.categoryItem.displayLabel, "Length")
        ...
        viewModel.didSelectUnit(convertedUnit: ConvertedUnitModel(value: "0", unit: UnitLength.meters))
    ...
    func testTemperatureConversions() {
        ...
        XCTAssertEqual(viewModel.categoryItem.displayLabel, "Temperature")
        ...
        viewModel.didSelectUnit(convertedUnit: ConvertedUnitModel(value: "0", unit: UnitTemperature.kelvin))
    ...
    func testMassConversions() {
        ...
        XCTAssertEqual(viewModel.categoryItem.displayLabel, "Mass")
        XCTAssertEqual(viewModel.selectedUnit, UnitMass.ounces)
        XCTAssertTrue(viewModel.convertedUnits.contains(where: { $0.unit == UnitMass.grams}))
        ...
        XCTAssertEqual(poundModel?.value, "61.25")
        viewModel.didSelectUnit(convertedUnit: ConvertedUnitModel(value: "0", unit: UnitMass.grams))
