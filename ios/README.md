[![iOS Platform](https://img.shields.io/badge/Platform-ios-lightgray?style=for-the-badge)](https://developer.apple.com/)
...
- [SwiftHEXColors]( https://github.com/thii/SwiftHEXColors) - Create UIColors using hex strings
- [SwiftySound](https://github.com/adamcichy/SwiftySound) - Wrapper for playing sounds easily. 

#  🚧 Resources 

Here's some additional resources used in this app but not included in the source code:

- [UI Sounds](https://uisoundkit2.appsounds.pro/) - `Click_Note2.caf` 
  - Not included due to license for sound. Can be replaced with other sound file. 
